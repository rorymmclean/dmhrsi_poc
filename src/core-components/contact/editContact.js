...
"PRIMARY_FLAG": data?.PRIMARY_FLAG==true?"Y":"N",
                        ...
                        isLoading: false,
                        disabled: !data?.CONTACT_TYPE?.length || !(data?.ADDRESS_TYPE?.length||data?.EMAIL_TYPE?.length||data?.PHONE_TYPE?.length ) ,
                        color: !data?.CONTACT_TYPE?.length || !(data?.ADDRESS_TYPE?.length||data?.EMAIL_TYPE?.length||data?.PHONE_TYPE?.length ) ? null : 'info'
                    }]}
 ...
 {rowData?.CONTACT_TYPE=="ADDRESS"?<> <GridItem xs={12} sm={12} md={6}>
                <FormControl fullWidth>
  <InputLabel id="demo-simple-select-label">Type</InputLabel>
  <Select
    labelId="demo-simple-select-label"
    id="demo-simple-select"
    value={data.ADDRESS_TYPE?.length?TYPE_NAME[data.ADDRESS_TYPE]:TYPE_NAME[rowData?.ADDRESS_TYPE]}
    label="Type"
...
<GridItem xs={12} sm={3} style={{ marginTop: '16px' }}>
                ...
                {rowData?.CONTACT_TYPE=="EMAIL"?<> <GridItem xs={12} sm={12} md={6}>
                <FormControl fullWidth>
  <InputLabel id="demo-simple-select-label">Type</InputLabel>
  <Select
    labelId="demo-simple-select-label"
    id="demo-simple-select"
                        value={data.EMAIL_TYPE?.length?TYPE_NAME[data.EMAIL_TYPE]:TYPE_NAME[rowData?.EMAIL_TYPE]}
        ...
        />} label="Primary" /></FormGroup>
                  ...
                  <TextField
                    ...
                    onChange={(e) => setData({ ...data, EMAIL_ADDRESS: e.target.value })}
                           ...
                           {rowData?.CONTACT_TYPE=="PHONE"?<> <GridItem xs={12} sm={12} md={6}>
                <FormControl fullWidth>
  <InputLabel id="demo-simple-select-label">Type</InputLabel>
  <Select
    labelId="demo-simple-select-label"
    id="demo-simple-select"
    value={data.PHONE_TYPE?.length?TYPE_NAME[data.PHONE_TYPE]:TYPE_NAME[rowData?.PHONE_TYPE]}
