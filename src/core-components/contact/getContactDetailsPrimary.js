...
export default function GetContactDetailsPrimary (props)
{
  ...
  return (!isLoading ?<GridItem xs={12} sm={12} >
           ...
           if ( item?.ADDRESS_TYPE?.length )
              {
                const addr = [ item?.ADDRESS_1, item?.ADDRESS_2, item?.ADDRESS_3, item?.COUNTRY, item?.STATE, item?.CITY, item?.POSTAL_CODE ].filter( item => item )
                s = addr.join( " ," );
                      ...
                      <GridItem xs={12} sm={12} md={6}>
                        <JPGrid container direction={'row'} justify={'flex-end'}>
                          <JPGrid item marginRight={3} marginLeft={3}>
                            <Button
                              onClick={() => {
                                history.push({
                                  pathname:ENTITITY_TYPE=="ORG"? `/admin/contact/${location.pathname.split('/')[3]}`:`/admin/contactPerson/${location.pathname.split('/')[3]}`,
                       ...
                       {select?.CONTACT_TYPE=="ADDRESS"?<> <GridItem xs={12} sm={12} md={6} style={{ marginTop: '16px' }}>
                <FormControl fullWidth>
  ...
  <Select
    labelId="demo-simple-select-label"
                              id="demo-simple-select"
                              disabled
    value={select.ADDRESS_TYPE?.length?TYPE_NAME[select.ADDRESS_TYPE]:TYPE_NAME[select?.ADDRESS_TYPE]}
    label="Type"
  ...
  >
    ...
    <MenuItem value={2}>Home</MenuItem>
                      ...
                      { select?.ADDRESS_1 ? <GridItem xs={ 12 } sm={ 12 } style={ { marginTop: '16px' } }>
                      ...
                      { select?.ADDRESS_2 ? <GridItem xs={ 12 } sm={ 12 } style={ { marginTop: '16px' } }>
                      ...
                      { select?.ADDRESS_3 ? <GridItem xs={ 12 } sm={ 12 } style={ { marginTop: '16px' } }>
...
<GridItem xs={12} sm={3} style={{ marginTop: '16px' }}>
                ...
                {select?.CONTACT_TYPE=="EMAIL"?<> <GridItem xs={12} sm={12} md={6} style={{ marginTop: '16px' }}>
                <FormControl fullWidth>
  <InputLabel id="demo-simple-select-label">Type</InputLabel>
  <Select
    labelId="demo-simple-select-label"
                              id="demo-simple-select"
                              disabled
                        value={select.EMAIL_TYPE?.length?TYPE_NAME[select.EMAIL_TYPE]:TYPE_NAME[select?.EMAIL_TYPE]}
    ...
    <MenuItem value={2}>Home</MenuItem>
                  ...
                  <TextField
                    ...
                    value={select?.EMAIL_ADDRESS}
                           ...
                           {select?.CONTACT_TYPE=="PHONE"?<> <GridItem xs={12} sm={12} md={6} style={{ marginTop: '16px' }}>
                <FormControl fullWidth>
  <InputLabel id="demo-simple-select-label">Type</InputLabel>
  <Select
    labelId="demo-simple-select-label"
                              id="demo-simple-select"
                              disabled
    value={select.PHONE_TYPE?.length?TYPE_NAME[select.PHONE_TYPE]:TYPE_NAME[select?.PHONE_TYPE]}
