...
import { addProjectAPI, editProjectAPI, getProjectDetailsAPI, getProjectListAPI } from './project-api';
...
export const getProjectDetailsThunk = createAsyncThunk('Project/Details', async (data, { dispatch }) => {
